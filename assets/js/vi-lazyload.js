...
(function(){
    ...
    *********************************************************************/
    var vimeo = document.querySelectorAll('.vi-lazyload'),
        ...
        settings_thumb_base_url         = '../../img/vimeo-logo.png',     //Base URL where thumbnails are stored
        ...
        vimeo_observer = new IntersectionObserver(function(elements){
            ...
            elements.forEach(function(e){
                ...
                if(e.isIntersecting === true){
                    ...
                    this_content.style.setProperty('--vi-lazyload-img','url("' + settings_thumb_base_url + this_data_thumb  + '")');
